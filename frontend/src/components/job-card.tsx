  ...
  return (
    ...
    >
      <div className="flex items-start gap-4">
        <div className="flex size-16 shrink-0 items-center justify-center overflow-hidden rounded-xl border border-slate-200 bg-white  shadow-sm">
          <Image
            src={job.logo || "/images/image-fallback.png"}
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-start gap-2 pr-8">
            ...
            {job.hot && (
              <Badge className="mr-3 shrink-0 border border-rose-200 bg-rose-50 text-[10px] font-bold text-rose-700 shadow-none">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        <Badge
          variant="outline"
          className="gap-1.5 rounded-lg border-slate-200 bg-slate-50 px-2.5 py-1.5 font-normal text-slate-600"
        >
      ...
      <div className="mt-4 flex items-center justify-between border-t border-slate-100 pt-4">
        ...
        <span className="flex items-center gap-1 text-xs font-semibold text-emerald-700 opacity-0 transition-opacity group-hover:opacity-100">
