...
const conversations = [
  { name: "Trần Minh Anh", role: "Senior Front-end Developer", job: "Senior ReactJS Developer", text: "Em xác nhận tham gia phỏng vấn ạ.", time: "10:24", unread: 2 },
  { name: "Lê Quốc Bảo", role: "UI/UX Designer", job: "Product Designer", text: "Cảm ơn anh/chị đã xem hồ sơ.", time: "Hôm qua", unread: 0 },
  { name: "Nguyễn Hoài Nam", role: "Automation Tester", job: "QA Engineer", text: "Em đã gửi portfolio trong CV.", time: "Thứ 4", unread: 0 },
]
...
export default function EmployerMessagesPage() {
  ...
  const [history, setHistory] = useState([
    "Chào Minh Anh, hồ sơ của bạn phù hợp với vị trí Senior ReactJS Developer.",
    "Em cảm ơn anh/chị. Mình có thể trao đổi thêm về lịch phỏng vấn không ạ?",
    "Bên mình mời bạn phỏng vấn online lúc 14:00 thứ Năm, ngày 22/08.",
    "Em xác nhận tham gia phỏng vấn ạ.",
  ])
  const current = conversations[active]
  function send() { if (!message.trim()) return; setHistory((items) => [...items, message.trim()]); setMessage("") }
